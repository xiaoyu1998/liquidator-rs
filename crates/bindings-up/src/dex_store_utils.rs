...
pub mod dex_store_utils {
    ...
    impl ::core::convert::From<EmptyDex> for DexStoreUtilsErrors {
        fn from(value: EmptyDex) -> Self {
            Self::EmptyDex(value)
        }
    }
    impl ::core::convert::From<EmptyUnderlyingAsset> for DexStoreUtilsErrors {
