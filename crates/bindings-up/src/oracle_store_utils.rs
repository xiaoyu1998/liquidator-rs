...
pub mod oracle_store_utils {
    ...
    impl ::core::convert::From<EmptyOracle> for OracleStoreUtilsErrors {
        fn from(value: EmptyOracle) -> Self {
            Self::EmptyOracle(value)
        }
    }
    impl ::core::convert::From<EmptyUnderlyingAsset> for OracleStoreUtilsErrors {
