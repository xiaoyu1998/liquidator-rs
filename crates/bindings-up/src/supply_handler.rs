...
pub mod supply_handler {
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            ...
                            inputs: ::std::vec![
                                ...
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("supplyParams"),
    ...
    pub static SUPPLYHANDLER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct SupplyHandler<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for SupplyHandler<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for SupplyHandler<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for SupplyHandler<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for SupplyHandler<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(SupplyHandler))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> SupplyHandler<M> {
        ...
        ///Calls the contract's `executeSupply` (0x4724f3da) function
        pub fn execute_supply(
            ...
            self.0
                .method_hash([71, 36, 243, 218], (account, supply_params))
                .expect("method not found (this should never happen)")
        }
    ...
    ///Container type for all input parameters for the `executeSupply` function with signature `executeSupply(address,(address,address))` and selector `0x4724f3da`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(name = "executeSupply", abi = "executeSupply(address,(address,address))")]
    pub struct ExecuteSupplyCall {
        pub account: ::ethers::core::types::Address,
        pub supply_params: SupplyParams,
    }
    ...
    pub enum SupplyHandlerCalls {
        DataStore(DataStoreCall),
        EventEmitter(EventEmitterCall),
        ExecuteSupply(ExecuteSupplyCall),
        RoleStore(RoleStoreCall),
    }
    impl ::ethers::core::abi::AbiDecode for SupplyHandlerCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for SupplyHandlerCalls {
    ...
    impl ::core::fmt::Display for SupplyHandlerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DataStoreCall> for SupplyHandlerCalls {
        fn from(value: DataStoreCall) -> Self {
            Self::DataStore(value)
        }
    }
    impl ::core::convert::From<EventEmitterCall> for SupplyHandlerCalls {
        fn from(value: EventEmitterCall) -> Self {
            Self::EventEmitter(value)
        }
    }
    impl ::core::convert::From<ExecuteSupplyCall> for SupplyHandlerCalls {
        fn from(value: ExecuteSupplyCall) -> Self {
            Self::ExecuteSupply(value)
        }
    }
    impl ::core::convert::From<RoleStoreCall> for SupplyHandlerCalls {
