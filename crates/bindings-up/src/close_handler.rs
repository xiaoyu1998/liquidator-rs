...
pub mod close_handler {
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            ...
                            inputs: ::std::vec![
                                ...
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("closeParams"),
    ...
    pub static CLOSEHANDLER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct CloseHandler<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for CloseHandler<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for CloseHandler<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for CloseHandler<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for CloseHandler<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(CloseHandler))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> CloseHandler<M> {
        ...
        pub fn execute_close(
            ...
            self.0
                .method_hash([174, 191, 23, 157], (account, close_params))
                .expect("method not found (this should never happen)")
        }
        ...
        pub fn execute_close_position(
            ...
            self.0
                .method_hash([162, 177, 243, 115], (account, close_params))
                .expect("method not found (this should never happen)")
        }
    ...
    pub struct ExecuteClosePositionCall {
        pub account: ::ethers::core::types::Address,
        pub close_params: ClosePositionParams,
    }
    ...
    impl ::ethers::core::abi::AbiDecode for CloseHandlerCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for CloseHandlerCalls {
    ...
    impl ::core::fmt::Display for CloseHandlerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DataStoreCall> for CloseHandlerCalls {
        fn from(value: DataStoreCall) -> Self {
            Self::DataStore(value)
        }
    }
    impl ::core::convert::From<EventEmitterCall> for CloseHandlerCalls {
        fn from(value: EventEmitterCall) -> Self {
            Self::EventEmitter(value)
        }
    }
    impl ::core::convert::From<ExecuteCloseCall> for CloseHandlerCalls {
        fn from(value: ExecuteCloseCall) -> Self {
            Self::ExecuteClose(value)
        }
    }
    impl ::core::convert::From<ExecuteClosePositionCall> for CloseHandlerCalls {
        fn from(value: ExecuteClosePositionCall) -> Self {
            Self::ExecuteClosePosition(value)
        }
    }
    impl ::core::convert::From<RoleStoreCall> for CloseHandlerCalls {
