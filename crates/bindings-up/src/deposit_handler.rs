...
pub mod deposit_handler {
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            ...
                            inputs: ::std::vec![
                                ...
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("depositParams"),
    ...
    pub static DEPOSITHANDLER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct DepositHandler<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for DepositHandler<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for DepositHandler<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for DepositHandler<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for DepositHandler<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(DepositHandler))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> DepositHandler<M> {
        ...
        pub fn execute_deposit(
            ...
            self.0
                .method_hash([213, 2, 113, 74], (account, deposit_params))
                .expect("method not found (this should never happen)")
        }
    ...
    impl ::ethers::core::abi::AbiDecode for DepositHandlerCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for DepositHandlerCalls {
    ...
    impl ::core::fmt::Display for DepositHandlerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DataStoreCall> for DepositHandlerCalls {
        fn from(value: DataStoreCall) -> Self {
            Self::DataStore(value)
        }
    }
    impl ::core::convert::From<EventEmitterCall> for DepositHandlerCalls {
        fn from(value: EventEmitterCall) -> Self {
            Self::EventEmitter(value)
        }
    }
    impl ::core::convert::From<ExecuteDepositCall> for DepositHandlerCalls {
        fn from(value: ExecuteDepositCall) -> Self {
            Self::ExecuteDeposit(value)
        }
    }
    impl ::core::convert::From<RoleStoreCall> for DepositHandlerCalls {
