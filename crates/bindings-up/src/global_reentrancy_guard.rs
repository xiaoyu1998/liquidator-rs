pub use global_reentrancy_guard::*;
...
pub mod global_reentrancy_guard {
    ...
    pub static GLOBALREENTRANCYGUARD_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct GlobalReentrancyGuard<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for GlobalReentrancyGuard<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for GlobalReentrancyGuard<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for GlobalReentrancyGuard<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for GlobalReentrancyGuard<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(GlobalReentrancyGuard))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> GlobalReentrancyGuard<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    GLOBALREENTRANCYGUARD_ABI.clone(),
                    client,
                ),
            )
        }
