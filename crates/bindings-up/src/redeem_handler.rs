...
pub mod redeem_handler {
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            ...
                            inputs: ::std::vec![
                                ...
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("redeemParams"),
    ...
    pub static REDEEMHANDLER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct RedeemHandler<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for RedeemHandler<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for RedeemHandler<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for RedeemHandler<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for RedeemHandler<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(RedeemHandler))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> RedeemHandler<M> {
        ...
        ///Calls the contract's `executeRedeem` (0x1965efe9) function
        pub fn execute_redeem(
            ...
            self.0
                .method_hash([25, 101, 239, 233], (account, redeem_params))
                .expect("method not found (this should never happen)")
        }
    ...
    ///Container type for all input parameters for the `executeRedeem` function with signature `executeRedeem(address,(address,uint256,address))` and selector `0x1965efe9`
    #[derive(
        Clone,
        ::ethers::contract::EthCall,
        ::ethers::contract::EthDisplay,
    ...
    #[ethcall(
        name = "executeRedeem",
        abi = "executeRedeem(address,(address,uint256,address))"
    )]
    pub struct ExecuteRedeemCall {
        pub account: ::ethers::core::types::Address,
        pub redeem_params: RedeemParams,
    }
    ...
    pub enum RedeemHandlerCalls {
        DataStore(DataStoreCall),
        EventEmitter(EventEmitterCall),
        ExecuteRedeem(ExecuteRedeemCall),
        RoleStore(RoleStoreCall),
    }
    impl ::ethers::core::abi::AbiDecode for RedeemHandlerCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for RedeemHandlerCalls {
    ...
    impl ::core::fmt::Display for RedeemHandlerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DataStoreCall> for RedeemHandlerCalls {
        fn from(value: DataStoreCall) -> Self {
            Self::DataStore(value)
        }
    }
    impl ::core::convert::From<EventEmitterCall> for RedeemHandlerCalls {
        fn from(value: EventEmitterCall) -> Self {
            Self::EventEmitter(value)
        }
    }
    impl ::core::convert::From<ExecuteRedeemCall> for RedeemHandlerCalls {
        fn from(value: ExecuteRedeemCall) -> Self {
            Self::ExecuteRedeem(value)
        }
    }
    impl ::core::convert::From<RoleStoreCall> for RedeemHandlerCalls {
