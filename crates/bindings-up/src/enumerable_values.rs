...
pub mod enumerable_values {
    ...
    pub static ENUMERABLEVALUES_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    pub struct EnumerableValues<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for EnumerableValues<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for EnumerableValues<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for EnumerableValues<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for EnumerableValues<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(EnumerableValues))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> EnumerableValues<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                ENUMERABLEVALUES_ABI.clone(),
                ENUMERABLEVALUES_BYTECODE.clone().into(),
                client,
            );
