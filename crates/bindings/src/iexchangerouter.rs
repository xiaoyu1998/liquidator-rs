...
```*/
    ...
    ///Container for all the [`IExchangeRouter`](self) function calls.
            ...
            ) -> alloy_sol_types::Result<IExchangeRouterCalls>] = &[
                {
                    fn executeAdd(
                        ...
                        <executeAddCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IExchangeRouterCalls::executeAdd)
                    }
                    executeAdd
                },
                {
                    fn executeSwap(
                        ...
                        <executeSwapCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IExchangeRouterCalls::executeSwap)
                    }
                    executeSwap
                },
                {
                    fn executeDeposit(
                        ...
                        <executeDepositCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IExchangeRouterCalls::executeDeposit)
                    }
                    executeDeposit
                },
                {
                    fn executeRepay(
                        ...
                        <executeRepayCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IExchangeRouterCalls::executeRepay)
                    }
                    executeRepay
                },
                {
                    fn executeBorrow(
                        ...
                        <executeBorrowCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IExchangeRouterCalls::executeBorrow)
                    }
                    executeBorrow
                },
                {
                    fn executeWithdraw(
                        ...
                        <executeWithdrawCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IExchangeRouterCalls::executeWithdraw)
                    }
                    executeWithdraw
                },
                {
                    fn executeSwapInPosition(
                        ...
                        <executeSwapInPositionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IExchangeRouterCalls::executeSwapInPosition)
                    }
                ...
                },
                {
                    fn executeLiquidation(
                        ...
                        <executeLiquidationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IExchangeRouterCalls::executeLiquidation)
                    }
                    executeLiquidation
                },
                {
                    fn executeClose(
                        ...
                        <executeCloseCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IExchangeRouterCalls::executeClose)
                    }
                    executeClose
                },
                {
                    fn executeRemove(
                        ...
                        <executeRemoveCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IExchangeRouterCalls::executeRemove)
                    }
                    executeRemove
                },
            ];
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`IExchangeRouter`](self) contract instance.

See the [wrapper's documentation](`IExchangeRouterInstance`) for more details.*/
    #[inline]
    pub const fn new<
        T: alloy_contract::private::Transport + ::core::clone::Clone,
        P: alloy_contract::private::Provider<T, N>,
    ...
    >(
        address: alloy_sol_types::private::Address,
        provider: P,
    ) -> IExchangeRouterInstance<T, P, N> {
        IExchangeRouterInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IExchangeRouterInstance<T, P, N>>,
    > {
        IExchangeRouterInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IExchangeRouterInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IExchangeRouter`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IExchangeRouter`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IExchangeRouterInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IExchangeRouterInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IExchangeRouterInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    #[automatically_derived]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IExchangeRouterInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IExchangeRouterInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IExchangeRouterInstance<T, P, N> {
            IExchangeRouterInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network_transport: ::core::marker::PhantomData,
            }
